% Cubic Splines 
 ...
 x = [0;30;60;80;105;125;140;175;240;278;];%6;7;8;9;10];           % data points
 y = [0;29;61;74;89;99;122;149;253;262;];%2;-1;5;8;6];     
...
c = zeros(n,1);
Mc = 2*diag(dx(1 : n - 2) + dx(2 : n - 1)) + diag(dx(2 : n - 2),-1) + diag(dx(2 : n - 2),1);
